  ...
  effects: [
    {
      ...
      params: [
        ...
        { id: "dry_mix", label: "Dry Mix", min: 0, max: 1, default: 0.1, unit: "" },
      ],
      presets: [
        { name: "Broadcast", values: { vad_threshold: 25, hold_ms: 200, lead_in_ms: 0, dry_mix: 0.1 } },
        { name: "Gentle", values: { vad_threshold: 25, hold_ms: 250, lead_in_ms: 0, dry_mix: 0.12 } },
        { name: "Aggressive", values: { vad_threshold: 75, hold_ms: 150, lead_in_ms: 0, dry_mix: 0.06 } },
      ],
    },
    {
      id: "highpass",
