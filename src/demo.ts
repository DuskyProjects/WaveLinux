...
function demoMutation(command: string, args?: Record<string, unknown>): unknown {
  ...
  if (command === "create_mix") {
    ...
    const mix: Mix = {
      id,
      name,
      virtual_sink_name: `wavelinux6_mix_${id}`,
      virtual_source_name: `wavelinux6_mix_${id}_source`,
      monitor_output: null,
      output_devices: [],
      icon: null,
      volume: 1,
  ...
  if (command === "create_channel") {
    ...
    const channel: Channel = {
      ...
      name,
      kind,
      virtual_sink_name: `wavelinux6_channel_${id}`,
      source_device: null,
      icon: null,
  ...
  if (command === "run_sound_check" || command === "run_diagnostics") {
    return {
      ...
      debug_log_path: "/home/dusky/.config/wavelinux6/wavelinux-engine.log",
  ...
  if (command === "set_channel_effects_enabled") {
    const channel = findChannel(stringArg(args, "channelId"));
    if (channel) {
      channel.effects_enabled = boolArg(args, "enabled", channel.effects_enabled);
      if (channel.effects_enabled && channel.effects.every((effect) => effect.bypassed)) {
        channel.effects = normalizeDemoEffectChain(
          channel.effects.map((effect) => ({ ...effect, bypassed: false })),
        );
      }
    }
    return channel ?? {};
        ...
        : [
            {
              domain: "device",
              program: "pactl",
              args: ["load-module", "module-null-sink", "sink_name=wavelinux6_mix_stream"],
  ...
  effects: [
    ...
    },
    {
      ...
      presets: [
        ...
        {
          name: "Noisy room -30 dB",
          values: { threshold_db: -30, range_db: -70, attack_ms: 1, hold_ms: 60, release_ms: 120 },
        },
        {
          name: "Nearby voices -20 dB",
          values: { threshold_db: -20, range_db: -90, attack_ms: 1, hold_ms: 60, release_ms: 100 },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      params: [
        ...
        { id: "reverb_time_s", label: "Room Time", min: 0.1, max: 8, default: 2.4, unit: " s" },
        { id: "room_level_db", label: "Room Level", min: -70, max: 0, default: -17, unit: " dB" },
      ],
      presets: [
        {
          name: "Small Room",
        ...
        {
          name: "Old Radio Announcer",
          values: {
            dry_mix: 0.92,
            tone_highpass_hz: 120,
            tone_lowpass_hz: 4600,
            tone_gain_db: 2.5,
            double_mix: 0.04,
            double_delay_ms: 18,
            detune_cents: 2,
        ...
        },
        {
          ...
          values: {
            dry_mix: 1,
            tone_highpass_hz: 320,
            tone_lowpass_hz: 3400,
            tone_gain_db: 1.5,
            double_mix: 0,
            double_delay_ms: 18,
            detune_cents: 0,
        ...
        },
        {
          ...
          values: {
            dry_mix: 0.82,
            tone_highpass_hz: 180,
            tone_lowpass_hz: 6000,
            tone_gain_db: 3,
            double_mix: 0.1,
            double_delay_ms: 34,
            detune_cents: 3,
  ...
  config: {
    ...
    settings: {
      ...
      adaptive_latency: {
        ...
        min_msec: 28,
        max_msec: 120,
        levels_msec: [28, 40, 60, 80, 100, 120],
        trigger_mode: "hybrid",
      },
    },
    mixes: [
      ...
      },
      {
        id: "stream",
        name: "Stream",
        virtual_sink_name: "wavelinux6_mix_stream",
        virtual_source_name: "wavelinux6_mix_stream_source",
        monitor_output: null,
        output_devices: [],
        icon: "radio",
        volume: 1,
      ...
      },
      {
        id: "discord_mix",
        name: "Discord Mix",
        virtual_sink_name: "wavelinux6_mix_discord_mix",
        virtual_source_name: "wavelinux6_mix_discord_mix_source",
        monitor_output: null,
        output_devices: [],
        icon: "chat",
        volume: 1,
        ...
        effects:
          index === 0
            ? [
                ...
                { instance_id: "demo-eq", effect_id: "eq", bypassed: false, params: {} },
